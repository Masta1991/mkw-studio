    ...
    function initAnimations() {
        ...
        reveals.forEach((el, i) => {
            gsap.to(el, {
                ...
                duration: 1.2,
                ease: "power4.out",
                delay: (i % 10) * 0.15 // Increased stagger and higher modulo for longer sequences
            });
        });
        ...
        portfolioItems.forEach((el, i) => {
            // Adding variation to trigger points and start positions for asynchronous feel
            const offset = (i % 3) * 40; 
            ...
            gsap.fromTo(el, 
                { y: 100 + offset, opacity: 0 },
                {
                    scrollTrigger: {
                        ...
                        scrub: 1.5, // Slightly slower scrub for smoother asynchronous motion
                    },
                    y: 0,
                    opacity: 1,
                    ease: "power1.out"
